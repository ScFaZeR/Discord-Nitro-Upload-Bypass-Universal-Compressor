...
2. Lancez l'installateur et choisissez votre langue.
3. Le logiciel s'installera sur votre PC et créera un raccourci sur votre bureau.

### 🌟 Fonctionnalités
- Contournement de la limite d'envoi Discord (10 Mo standard / 500 Mo Nitro).
- Interface propre en "Drag & Drop".
- Supporte les formats MP4, MKV, MOV, AVI, MP3, WAV, PNG, JPG.
- Compression ultra-rapide basée sur FFmpeg.

### 🤝 Liens Utiles
- **Rejoindre le Discord :** [Cliquez ici](https://discord.gg/MsguHxUfGX)
- **Faire un don :** [Soutenez le projet via PayPal](https://www.paypal.com/paypalme/scfazer)
...
3. The software will install on your PC and create a shortcut on your desktop.

### 🌟 Features
- Bypasses Discord upload limits (10MB standard / 500MB Nitro).
- Clean Drag & Drop interface.
- Supports MP4, MKV, MOV, AVI, MP3, WAV, PNG, JPG formats.
- Blazing fast compression powered by FFmpeg.

### 🤝 Useful Links
- **Join Discord:** [Click here](https://discord.gg/MsguHxUfGX)
- **Donate:** [Support the project via PayPal](https://www.paypal.com/paypalme/scfazer)
...
3. Программа установится на ваш ПК и создаст ярлык на рабочем столе.

### 🌟 Особенности
- Обход лимитов Discord (стандартные 10 МБ / 500 МБ Nitro).
- Чистый интерфейс "Drag & Drop".
- Поддержка форматов MP4, MKV, MOV, AVI, MP3, WAV, PNG, JPG.
- Сверхбыстрое сжатие на базе FFmpeg.

### 🤝 Полезные ссылки
- **Присоединиться к Discord:** [Нажмите здесь](https://discord.gg/MsguHxUfGX)
- **Пожертвовать:** [Поддержите проект через PayPal](https://www.paypal.com/paypalme/scfazer)
...
2. Ejecuta el instalador y elige tu idioma.
3. El software se instalará en tu PC y creará un acceso directo en tu escritorio.

### 🌟 Características
- Evita los límites de subida de Discord (10 MB estándar / 500 MB Nitro).
- Interfaz limpia "Drag & Drop".
- Soporta formatos MP4, MKV, MOV, AVI, MP3, WAV, PNG, JPG.
- Compresión ultrarrápida impulsada por FFmpeg.

### 🤝 Enlaces Útiles
- **Únete a Discord:** [Haz clic aquí](https://discord.gg/MsguHxUfGX)
- **Donar:** [Apoya el proyecto a través de PayPal](https://www.paypal.com/paypalme/scfazer)
...
2. 运行安装程序并选择您的语言。
3. 软件将安装在您的电脑上，并在桌面上创建一个快捷方式。

### 🌟 功能特点
- 绕过 Discord 上传限制（标准 10MB / Nitro 500MB）。
- 简洁的拖放（Drag & Drop）界面。
- 支持 MP4, MKV, MOV, AVI, MP3, WAV, PNG, JPG 格式。
- 基于 FFmpeg 的极速压缩。
